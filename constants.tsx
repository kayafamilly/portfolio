...
export const PROJECTS: Record<'fr' | 'en', Project[]> = {
  fr: [
    ...
    { id: '5', title: 'Recruitment-Agent', description: 'Agent IA de recrutement automatisé pour optimiser vos processus RH.', tags: ['AI', 'Recruitment', 'Automation'], imageUrl: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=1000', link: 'https://myrecruitment-agent.com/', category: 'AI' },
    { id: '6', title: 'Associé', description: 'Plateforme pour trouver le co-fondateur idéal pour votre projet entrepreneurial.', tags: ['Web', 'Startup', 'Networking'], imageUrl: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1000', link: 'https://www.trouve-ton-associe.online/', category: 'Web' }
  ],
  en: [
    ...
    { id: '5', title: 'Recruitment-Agent', description: 'Automated AI recruitment agent to optimize your HR processes.', tags: ['AI', 'Recruitment', 'Automation'], imageUrl: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=1000', link: 'https://myrecruitment-agent.com/', category: 'AI' },
    { id: '6', title: 'Associé', description: 'Platform to find the ideal co-founder for your entrepreneurial project.', tags: ['Web', 'Startup', 'Networking'], imageUrl: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1000', link: 'https://www.trouve-ton-associe.online/', category: 'Web' }
  ]
};
