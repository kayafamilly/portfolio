...
export const PROJECTS: Record<'fr' | 'en', Project[]> = {
  fr: [
    { id: '1', title: 'VibeMobileStudio', description: 'Plateforme IA pour transformer des idées en prototypes mobiles en 20min.', tags: ['AI', 'No-code', 'Prototyping'], imageUrl: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1000', link: 'https://vibe-ai-studio.com/vibemobile/', category: 'AI' },
    ...
    { id: '3', title: 'Recruitment-Agent', description: 'Agent IA de recrutement automatisé pour optimiser vos processus RH.', tags: ['AI', 'Recruitment', 'Automation'], imageUrl: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=1000', link: 'https://myrecruitment-agent.com/', category: 'AI' },
    { id: '4', title: 'NiceToMeetYou', description: 'Site d\'échange linguistique pour pratiquer avec des natifs.', tags: ['React', 'WebRTC', 'Next.js'], imageUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=1000', link: 'https://www.nice-to-meet-u.com/', category: 'Web' }
  ],
  en: [
    { id: '1', title: 'VibeMobileStudio', description: 'AI platform to transform ideas into mobile prototypes in 20min.', tags: ['AI', 'No-code', 'Prototyping'], imageUrl: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1000', link: 'https://vibe-ai-studio.com/vibemobile/', category: 'AI' },
    ...
    { id: '3', title: 'Recruitment-Agent', description: 'Automated AI recruitment agent to optimize your HR processes.', tags: ['AI', 'Recruitment', 'Automation'], imageUrl: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=1000', link: 'https://myrecruitment-agent.com/', category: 'AI' },
    { id: '4', title: 'NiceToMeetYou', description: 'Language exchange platform to practice with native speakers.', tags: ['React', 'WebRTC', 'Next.js'], imageUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=1000', link: 'https://www.nice-to-meet-u.com/', category: 'Web' }
  ]
};
